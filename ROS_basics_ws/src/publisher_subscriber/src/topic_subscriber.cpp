...
#include "publisher_subscriber/MsgTutorial.h"  // MsgTutorial Message File Header. The header file is automatically created when building the package.
...
int main(int argc, char **argv)                         // Node Main Function
{
  ...
  ros::Subscriber ros_tutorial_sub =
   nh.subscribe("ros_tuto_msg", 100, msgCallback);
